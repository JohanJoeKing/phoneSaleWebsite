 ...
 * - Filename : systemGoods.aspx.cs
 * - Author : 刘畅    Version : 1.0   Date : 2018/5/30
 * - Description : 本文件为系统管理我的商品界面
 * - Function list :
 * 1.Page_Load
...
public partial class systemGoods : System.Web.UI.Page
{
    // 数据库连接
    private MyDatabase MDB;
    private const string SELECT_PHONE_DATA = "select * from systemphoneView";
